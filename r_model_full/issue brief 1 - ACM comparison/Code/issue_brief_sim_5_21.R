  ...
  ri <- policy_simulation(saveCSV=TRUE,
                            ...
                            maxlen_illspouse =20, maxlen_illchild =20, maxlen_total=150, earnings=3840,output=paste0("RI_",meth,"issue_brief_1_5_21"),
  ...
  policy_simulation(saveCSV=TRUE,
                    ...
                    maxlen_illspouse =30, maxlen_illchild =30, maxlen_total=130, earnings=8400,output=paste0("NJ_",meth,"issue_brief_1_5_21"),
                    output_stats=c('state_compar'),  random_seed=12312)
  timeend <<- Sys.time()
  print(timeend - timestart)
  ...
  policy_simulation(saveCSV=TRUE,
                            ...
                            maxlen_illspouse =30, maxlen_illchild =30, maxlen_total=260, earnings=300,output=paste0("CA_",meth,"issue_brief_1_5_21"),
                            output_stats=c('state_compar'),  random_seed=12312)
  timeend <<- Sys.time()
  print(timeend - timestart)
