...
ri <- policy_simulation(saveCSV=TRUE,
                        ...
                        dependent_allow = 10,
                        sens_var='resp_len',
                        own_uptake= .0822, matdis_uptake=.0274, bond_uptake=.0104, illparent_uptake=.0009,
                        illspouse_uptake=.0015, illchild_uptake=.0006,
...
policy_simulation(saveCSV=TRUE,
                  ...
                  dependent_allow = 10,
                  sens_var='resp_len',
                  own_uptake=.0255, matdis_uptake=.0090, bond_uptake=.0094, illparent_uptake=.0006,
                  illspouse_uptake=.0006, illchild_uptake=.0005,
...
policy_simulation(saveCSV=TRUE,
                  ...
                  sens_var='resp_len',
                  #topoff_rate=.06, topoff_minlength=20, 
                  own_uptake=.0378, matdis_uptake=.0110, bond_uptake=.0133, illparent_uptake=.0045,
                  illspouse_uptake=.0045, illchild_uptake=.0028,
